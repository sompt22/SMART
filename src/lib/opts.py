...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--embedding_loss', default='focal',
                             help='embedding loss: ce | focal')
    self.parser.add_argument('--embedding_weight', type=float, default=0.1,
                             help='loss weight for embedding')    
    self.parser.add_argument('--embedding_dim', type=int, default=128,
                             help='feature dim for embedding')
    self.parser.add_argument('--know_dist_weight', type=float, default=0.1,
                             help='loss weight for knowledge distillation loss')
